...
GENESIS_P67B_MARKER = "Genesis P67b spec-verify forward() routing v7.45_buf_reuse_fix2"
...
P67B_NEW = (
    ...
    "                        # Fix: use a separate per-K1 holder on self so decode-path\n"
    "                        # buffers are never touched. The kernel self-allocates the\n"
    "                        # correct size on first K+1 dispatch (via buf_holder) and\n"
    "                        # caches it there. Grows automatically when B increases.\n"
